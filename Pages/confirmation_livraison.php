...
?>
  ...
  <div class="jumbotron text-center">
            ...
            <hr class="my-4">
            <p>Confirmez vos livraisons en quelques clics!</p>
        </div>

<div class="container mt-5">
    <div class="card col-md-6 mx-auto">
        <div class="card-header bg-primary text-white"><h1>Confirmer une livraison ici</h1></div>
        <div class="card-body"> 
            <form method="POST" action="confirm_delivry.php">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block" onclick="return confirm('Voulez-vous vraiment confirmer avoir livrer ce produit?')">CONFIRMER LA LIVRAISON</button>
                </div>
            </form>
        </div>
    </div>
